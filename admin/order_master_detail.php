            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                        ...
                        <div class="card-body--">
                           <div class="table-stats order-table ov-h">
                              <table class="table">
										...
										.postcode from order_detail,product ,`order` where order_detail.order_id='
										$order_id' and order_detail.product_id=product.id");*/
										
										$res=mysqli_query($con,"select distinct(order_detail.id)
										,order_detail.*,product.name,product.image,`order`.address,`order`.city,`order`.postcode 
									...
									order_status,`order` where `order`.id='$order_id' and 
					...
					//echo "<script> 	alert('$categories_id');</script>";
