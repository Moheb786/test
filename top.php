...
if(isset($_GET['USER_LOGIN'])){
	...
	$wishlist_count=mysqli_num_rows(mysqli_query($con,"select 
	product.name,product.image,product.price,product.mrp,wishlist.id from
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            ...
                            <div class="col-md-3 col-lg-4 col-sm-4 col-xs-4">
								...
								<div class="header__search search__open">
								<a href="#"><i class="icon-magnifier icons"></i></a>
								   ...
								   ?>
									...
									?>
                                        ...
                                        <a href="wishlist.php"><span class="htc__wishlist"><?php echo $wishlist_count ?>
										</span></a>
