...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"insert into `order` (user_id,address,city,postcode,payment_type,payment_status,order_status,added_on,total_price)
	values('$user_id','$address','$city','$postcode','$payment_type','$payment_status','$order_status','$added_on','$total_price')");
	...
	mysqli_query($con,"insert into `order_detail` 
                            ...
                            <div class="order-details__item">
								...
								<div class="single-item">
                                    ...
                                    <div class="single-item__remove">
                                        <a href="javascript:void(0)" onclick="manage_cart('<?php
											echo $key?>','remove')"><i class="icon-trash icons"></i></a>
                                    </div>
                                </div>
									<?php } ?>
                            </div>
